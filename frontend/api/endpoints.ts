...
type SecondParameter<T extends (...args: any) => any> = Parameters<T>[1];
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      {url: `http://192.168.0.103:8080/api/v1/preference/addPreferenceForUser`, method: 'POST',
...
export const register = (
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      {url: `http://192.168.0.103:8080/api/v1/auth/register`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
...
export const authenticate = (
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      {url: `http://192.168.0.103:8080/api/v1/auth/authenticate`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
...
export const getPreferencesByUserId = (
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      {url: `http://192.168.0.103:8080/api/v1/preference/getPreferencesByUserId`, method: 'GET',
        params
    },
      options);
    }
...
export const getAllPreferences = (
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      return customInstance<string[]>(
      {url: `http://192.168.0.103:8080/api/v1/preference/getAllPreferences`, method: 'GET'
    },
      options);
    }
